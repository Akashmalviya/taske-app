import { FormGroup, ValidationErrors, ValidatorFn, AbstractControl, Validators } from '@angular/forms';
...
export function password(registerForm: FormGroup) {
  ...
  const { value: confirmPassowrd } = registerForm.get('confirmPassowrd');
  return password === confirmPassowrd ? null : { passwordNotMatch: true };
}
